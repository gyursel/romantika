...
function DishCard({ d, dark, badgeColors, index }) {
  ...
  return (
    <div style={{
      ...
      border: `0.5px solid ${dark ? 'rgba(184,134,11,0.25)' : 'rgba(139,94,24,0.3)'}`,
      borderRadius: 12,
      marginBottom: 8,
      overflow: 'hidden',
      opacity: visible ? 1 : 0,
    ...
    <>
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-3d-dark:active {
          box-shadow: 0 1px 0 #4a3308, 0 4px 10px rgba(0,0,0,0.4) !important;
        }

        .btn-3d-light:active {
          box-shadow: 0 1px 0 #B8860B, 0 4px 10px rgba(122,92,0,0.2) !important;
        }
          ...
          {Array.isArray(menu.fullMenuImages) && menu.fullMenuImages.length > 0 && (
            <div style={{ padding: '1rem 1.25rem 0' }}>
              <button
                ...
                className={`btn-3d ${dark ? 'btn-3d-dark' : 'btn-3d-light'}`}
                style={{
                  width: '100%',
                  padding: '13px 14px',
                  borderRadius: 12,
                  ...
                  boxShadow: dark
                    ? '0 6px 0 #4a3308, 0 12px 22px rgba(0,0,0,0.45)'
                    : '0 6px 0 #B8860B, 0 10px 20px rgba(122,92,0,0.25)'
                }}
              >
                📖 Виж цялото меню
              </button>
