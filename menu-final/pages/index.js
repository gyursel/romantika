  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '0.875rem 1rem', display: 'flex', justifyContent: 'space-between', gap: 8 }}>
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontStyle: 'italic', fontSize: 21, fontWeight: 600, letterSpacing: '0.01em', color: dark ? '#FBEFC2' : '#1A1208', marginBottom: 3 }}>{d.name}</div>
...
export default function Home() {
  ...
  const todayDateLabel = new Date().toLocaleDateString('bg-BG', { day: 'numeric', month: 'long', year: 'numeric' });
  ...
  return (
    <>
      <Head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;0,600;1,500;1,600;1,700&display=swap" rel="stylesheet" />
      </Head>
