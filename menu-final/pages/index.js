    ...
    <>
      ...
      {screen === 'menu' && menu && (
        <div style={{ background: bg, minHeight: '100vh', transition: 'background 0.3s' }}>
          ...
          {/* Phone bar */}
          {menu.phone && (
            <div style={{ background: '#B8860B', color: '#1A1208', textAlign: 'center', padding: '7px 1rem', fontSize: 14, fontWeight: 600, letterSpacing: '1.03em', animation: 'fadeDown 0.4s ease' }}>
