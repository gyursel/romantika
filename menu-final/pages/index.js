...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Броим посещение веднъж на ден за това устройство (не при всяко презареждане/навигация).
    if (localStorage.getItem('menu_visit_counted') !== todayKey) {
      setDoc(statsRef, { count: increment(1), date: todayKey }, { merge: true })
        .then(() => localStorage.setItem('menu_visit_counted', todayKey))
        .catch(() => {});
    }
          ...
          >
            ...
            <div className="hero-copy">
              ...
              <div className="hero-meta">
                ...
                <span>👥 {visitorCount !== null ? visitorCount : '…'} посещения днес</span>
              </div>
            </div>
          </div>
